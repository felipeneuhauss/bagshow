 ...
 *
 * Copyright (c) 2006 - 2011 Jarn Zaefferer
 *
...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            remote: "Registro já cadastrado no sistema.",
            ...
            accept: "Selecione um arquivo com uma extensão válida.",
            maxlength: $.validator.format("Informe no máximo {0} caracteres."),
            minlength: $.validator.format("Informe no mínimo {0} caracteres."),
            rangelength: $.validator.format("Informe um valor com um valor entre {0} e {1} caracteres."),
