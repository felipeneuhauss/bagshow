...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl:'/lib/angularjs-ui/modules/bootstrap/template/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl:'/lib/angularjs-ui/modules/bootstrap/template/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/datepicker/datepicker.html',
    scope: {
      dateDisabled: '&'
    },
...
.directive('datepickerPopupWrap', [function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/datepicker/popup.html',
    link:function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(config) {
  return {
    ...
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/pagination/pagination.html',
    replace: true,
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/pagination/pager.html',
    replace: true,
    link: function(scope, element, attrs, paginationCtrl) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/tabs/tabset.html',
...
function($parse, $http, $templateCache, $compile) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('tabsetTitles', function($http) {
  return {
    restrict: 'A',
    require: '^tabset',
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/tabs/tabset-titles.html',
    replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: '/lib/angularjs-ui/modules/bootstrap/template/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'/lib/angularjs-ui/modules/bootstrap/template/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
    return {
      ...
      link:function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || '/lib/angularjs-ui/modules/bootstrap/template/typeahead/typeahead-match.html';
